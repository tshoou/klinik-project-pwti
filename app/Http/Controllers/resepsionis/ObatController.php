...
class ObatController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('resepsionist.obat.index', ['Obat' => $listObat]);
    }
    ...
    {
        return view('resepsionist.obat.tambah');
    }
    public function simpan(Request $req)
    {
        ...
        return redirect()->route('resepsionist.obat')->with('message', 'Data Berhasil Ditambah');
    }
    ...
    public function edit($id_obat)
    {
        ...
        return view('resepsionist.obat.edit', ['obat' => $listObat]);
    }
    ...
    public function update(Request $req, $id_obat)
    {
        ...
        return redirect()->route('resepsionist.obat')->with('message', "Data Berhasil Disunting");
    }
    ...
    public function delete($id_obat)
    {
        ...
        return redirect()->route('resepsionist.obat')->with('message', "Data Berhasil Dihapus");
    }
}
