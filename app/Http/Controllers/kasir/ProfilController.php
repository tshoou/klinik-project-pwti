...
class ProfilController extends Controller
{
    ...
    public function index($id_pegawai)
    {
        ...
        return view('kasir.profil.index', ['profil' => $profil]);
    }
    public function edit($id_pegawai)
    {
        ...
        return view('kasir.profil.edit', ['profil' => $profil]);
    }
    public function update(Request $req, $id_pegawai)
    {
        ...
        return redirect()->route('kasir.home')->with('message', 'Profil berhasil diedit');
    }
    public function updateFoto(Request $req, $id_pegawai)
    {
        ...
        return redirect()->route('kasir.home')->with('message', 'Foto Profil berhasil diedit');
    }
}
